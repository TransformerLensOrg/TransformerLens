...
- [devtools/adapter_builder/](devtools/adapter_builder/README.md) — autonomous agent-team adapter builder (contributor tooling, Max tier); manual path is `/add-model-support`.
