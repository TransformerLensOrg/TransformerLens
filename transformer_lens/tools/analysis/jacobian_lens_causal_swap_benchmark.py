...
corpus definition. Generating the frozen artifact consumed by
``demos/Jacobian_Lens_Coordinate_Patch_Benchmark_Demo.ipynb`` is a separate entry point:
``transformer_lens.tools.analysis.jacobian_lens_causal_swap_benchmark_cli``.
"""
