    ...
    def __init__(self, cfg: Any) -> None:
        ...
        self.weight_processing_conversions = {
                ...
                "blocks.{i}.attn.q": ParamProcessingConversion(
                    tensor_conversion=RearrangeTensorConversion("d_model (n d_head) -> n d_model d_head"),
                ...
                "blocks.{i}.attn.o": ParamProcessingConversion(
                    tensor_conversion=RearrangeTensorConversion("(n d_head) d_model -> n d_head d_model"),
