"""Model bridge base class.

This module contains the base class for model bridges that map between different model architectures.
"""
...
class ModelBridge:
    """Base class for model bridges.
    
    This class provides the interface for bridging between different model architectures.
    ...
    def __init__(self, cfg: TransformerLensConfig):
        ...
        Args:
            cfg: The config to use for the bridge.
        """
        self.cfg = cfg
