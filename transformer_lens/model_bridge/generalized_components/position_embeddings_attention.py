...
class PositionEmbeddingsAttentionBridge(AttentionBridge):
    ...
    def __init__(self, name: str, config: Any, submodules: Optional[Dict[str, Any]]=None, **kwargs):
    ...
    def forward(self, *args: Any, **kwargs: Any) -> Any:
        ...
        if isinstance(output, tuple) and len(output) >= 2:
            ...
            if attn_weights is not None:
                ...
                with torch.no_grad():
                    d_head = self.config.head_dim if self.config and hasattr(self.config, 'head_dim') else 256
