...
class GeneralizedComponent(nn.Module):
    ...
    def __setattr__(self, name: str, value: Any) -> None:
        ...
        if (name.startswith('_') or 
            name in ['name', 'config', 'submodules', 'conversion_rule', 'compatibility_mode', 'disable_warnings', 'hook_in', 'hook_out']):
        ...
        if (hasattr(self, '_modules') and 
            '_original_component' in self._modules):
