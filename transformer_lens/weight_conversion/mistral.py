        ...
        super().__init__(
            {
                ...
                "blocks": ("model.layers", WeightConversionSet({
                    ...
                    "attn.W_K": (
                        ...
                        RearrangeWeightConversion("(n h) m->n m h", n=number_key_value_heads),
                    ),
                    "attn.W_V": (
                    ...
                    "attn.b_K": torch.zeros(number_key_value_heads, cfg.d_head, dtype=cfg.dtype),
                    "attn.b_V": torch.zeros(number_key_value_heads, cfg.d_head, dtype=cfg.dtype),
                    "attn.W_O": (
