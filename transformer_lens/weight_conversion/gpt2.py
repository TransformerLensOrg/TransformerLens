        ...
        super().__init__({
            ...
            "blocks": ("transformer.h", WeightConversionSet({
                ...
                "attn.W_Q": (
                    ...
                    RearrangeWeightConversion(
                        "m (i h)->i m h",
                        input_filter=lambda weight: torch.tensor_split(weight, 3, dim=1)[0],
                        i=cfg.n_heads,
                    ),
                ),
                "attn.W_K": (
                    ...
                    RearrangeWeightConversion(
                        "m (i h)->i m h",
                        input_filter=lambda weight: torch.tensor_split(weight, 3, dim=1)[1],
                        i=cfg.n_heads,
                    ),
                ),
                "attn.W_V": (
                    ...
                    RearrangeWeightConversion(
                        "m (i h)->i m h",
                        input_filter=lambda weight: torch.tensor_split(weight, 3, dim=1)[2],
                        i=cfg.n_heads,
                    ),
                ),
                "attn.b_Q": (
