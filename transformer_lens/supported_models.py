...
MODEL_ALIASES: dict[str, list[str]] = {
    ...
    "google/vit-huge-patch16-224": ["vit-h", "ViT-H"],
    ...
    "facebook/deit-base-distilled-patch16-224": ["deit-d", "DeiT-d", "deit-D", "DeiT-D", "facebook/deit-base-distilled-patch16-224", "deit-base-distilled-patch16-224", "deit-distilled", "DeiT-distilled", "deit-distill", "DeiT-distill"],
    "facebook/deit-small-distilled-patch16-224": ["deit-sd", "DeiT-sd", "deit-SD", "DeiT-SD", "facebook/deit-small-distilled-patch16-224", "deit-small-distilled-patch16-224"],
    "facebook/deit-tiny-distilled-patch16-224": ["deit-td", "DeiT-td", "deit-TD", "DeiT-TD", "facebook/deit-tiny-distilled-patch16-224", "deit-tiny-distilled-patch16-224"],
    "gpt2": ["gpt2-small"],
