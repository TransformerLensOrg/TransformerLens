...
MODEL_ALIASES: dict[str, list[str]] = {
    ...
    "facebook/deit-base-distilled-patch16-224": ["deit", "deit-b", "DeiT-B"],
    "facebook/deit-small-distilled-patch16-224": ["deit-s", "DeiT-S"],
    "facebook/deit-tiny-patch16-224": ["deit-t", "DeiT-T", "deit-ti", "DeiT-Ti"],
    "gpt2": ["gpt2-small"],
