...
class HookedTransformer(HookedRootModule):
        ...
        if (
            ...
            if attention_mask is None:
                ...
                if self.tokenizer is None:
                    raise ValueError(
                        "Cannot compute attention mask without a tokenizer."
                    )
    ...
    def refactor_factored_attn_matrices(self, state_dict: Dict[str, torch.Tensor]):
        ...
        for l in range(self.cfg.n_layers):
            ...
            b_V_expanded = einops.rearrange(
                b_V, "head_index d_head -> head_index d_head 1"
            )
    ...
    def set_ungroup_grouped_query_attention(
        self, ungroup_grouped_query_attention: bool
    ):
        """
