...
notebook-test:
	poetry run pytest --sanitize-with demos/doc_sanitize.cfg demos/Main_Demo.ipynb 
	poetry run pytest --sanitize-with demos/doc_sanitize.cfg demos/Exploratory_Analysis_Demo.ipynb
