...
def get_olmo3_config(
    ...
    return TransformerBridgeConfig(**_olmo3_config_kwargs(n_layers, use_qk_norm, n_key_value_heads))
...
class TestOlmo3StateDictLoads:
    ...
    def test_converted_dict_loads_with_nonzero_kv(self):
        ...
        # HookedTransformer needs its own config class, not the bridge config.
        ht_cfg = HookedTransformerConfig(**_olmo3_config_kwargs(n_layers=1, n_key_value_heads=2))
