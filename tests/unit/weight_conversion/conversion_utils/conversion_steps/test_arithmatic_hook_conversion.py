...
def test_arithmetic_operations(operation, value, input_tensor, expected_output):
    conversion = ArithmeticHookConversion(operation, value)
...
def test_scalar_operations():
    conversion = ArithmeticHookConversion(OperationTypes.MULTIPLICATION, 10)
    assert conversion.convert(5) == 50


def test_tensor_operations():
    input_tensor = torch.tensor([1.0, 2.0, 3.0])
    conversion = ArithmeticHookConversion(OperationTypes.ADDITION, torch.tensor([1.0, 1.0, 1.0]))
...
def test_input_filter():
    ...
    conversion = ArithmeticHookConversion(OperationTypes.ADDITION, 3, input_filter=input_filter)
...
def test_output_filter():
    ...
    conversion = ArithmeticHookConversion(OperationTypes.ADDITION, 3, output_filter=output_filter)
