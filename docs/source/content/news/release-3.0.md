...
Additionally, I am working on an automated Claude tool for TransformerBridge architecture adapters. It will allow contributors to have the foundation for an architecture adapter generated by Claude based on the HuggingFace architecture ID. This is the next big step for increasing TransformerLens's ability to support new models as they release, and just the first step towards my goal of potentially automating architecture adapter creation in the future.
